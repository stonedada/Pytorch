...
# SSIM Boxplot
a = ax1.boxplot(ssim_factin, positions=x1, patch_artist=True, showmeans=True,
...
# PSNR Boxplot
ax2 = ax1.twinx()
b = ax2.boxplot(psnr_factin, positions=x2, patch_artist=True, showmeans=True,
...
plt.tight_layout()
plt.savefig('./f-actin_ssim_psnr_3.png')
plt.show()  # 展示
